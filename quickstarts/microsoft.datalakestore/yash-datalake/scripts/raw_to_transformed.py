...
def main(storage_account_name, container_name):
    ...
    customer_df = spark.read.csv(
        f"wasbs://{container_name}@{storage_account_name}.blob.core.windows.net/datasets/customers"
    )
    ...
    customer_df.write.csv(
        f"wasbs://transformed@{storage_account_name}.blob.core.windows.net/datasets/customers",
        mode='overwrite',
    )
    ...
    '''
        ********************************************************************************************************
        '''
    demographic_df = spark.read.csv(
        f"wasbs://{container_name}@{storage_account_name}.blob.core.windows.net/datasets/demographics"
    )
    ...
    demographic_df.write.csv(
        f"wasbs://transformed@{storage_account_name}.blob.core.windows.net/datasets/demographics",
        mode='overwrite',
    )
    ...
    order_df = spark.read.csv(
        f"wasbs://{container_name}@{storage_account_name}.blob.core.windows.net/datasets/orders"
    )
    ...
    order_df.write.csv(
        f"wasbs://transformed@{storage_account_name}.blob.core.windows.net/datasets/orders",
        mode='overwrite',
    )
    '''
        *******************************************************************************************************
    ...
    product_df = spark.read.csv(
        f"wasbs://{container_name}@{storage_account_name}.blob.core.windows.net/datasets/products"
    )
    ...
    product_df.write.csv(
        f"wasbs://transformed@{storage_account_name}.blob.core.windows.net/datasets/products",
        mode='overwrite',
    )
